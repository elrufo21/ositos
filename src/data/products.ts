...
export const products: Product[] = [
  {
    ...
    brand: 'OSITOS',
    name: 'Polera Personalizada Ositos',
    price: 89,
    oldPrice: 129,
    whatsapp: '51987273456',
    cover: `${ositosProductPath}/POLERA%20OSITOS%20LANDING_0000_1.jpg`,
    description: 'Poleras personalizadas con el nombre de tus hijos. Perfectas para compartir en familia. Algodón premium, no destiñe, fácil de lavar.',
    flyers: [
    ...
    sizes: [
      'Baby 0-3M', 'Baby 3-6M', 'Baby 6-12M', 'Baby 12-18M', 'Baby 18-24M',
      'Kids T4', 'Kids T6', 'Kids T8', 'Kids T10', 'Kids T12', 'Kids T14', 'Kids T16',
