  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Poleras personalizadas OSITOS con el nombre de tus hijos. Hechas con algodón premium, perfectas para compartir en familia. ¡Precios únicos por temporada!"
        />
        <meta
          name="keywords"
          content="poleras personalizadas, ropa familiar, OSITOS, regalo papá, día del padre, poleras con nombre"
        />
